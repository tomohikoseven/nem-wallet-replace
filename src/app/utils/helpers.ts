...
export class Helpers {
     ...
     */
    static haveWallet(walletName: string, array):boolean {
        let i = null;
     ...
     */
    static calcNumberOfPages(array, pageSize:number):number {
     ...
     */
    static toFixed4(value:number):string {
     ...
     */
    static cleanMosaicAmounts(elem, mosaicDefinitions) {
     ...
     */
    static namespaceIsValid(ns:string, isParent:boolean):boolean {
     ...
     */
    isHexadecimal = nem.utils.helpers.isHexadecimal;
     ...
     */
    isTextAmountValid = nem.utils.helpers.isTextAmountValid;
     ...
     * @return {boolean} - True if valid, false otherwise
     */
    static isValidForExchanges(entity):boolean {
     ...
     */
    static fixTimestamp(transaction, chainTime:number, network:number) {
        let d = new Date();
